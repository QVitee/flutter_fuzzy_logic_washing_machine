...
class DirtTypeChart extends StatelessWidget {
  final DirtTypeState state;
  DirtTypeChart({this.state});
  @override
  ...
  getSmall() => LineChartBarData(
        spots: [
          ...
          FlSpot(state.value, state.type.getNotGreasy),
          FlSpot(0, state.type.getNotGreasy),
        ],
        isCurved: false,
        curveSmoothness: 0,
        colors: const [
  ...
  getMedium() => LineChartBarData(
        spots: [
          FlSpot(state.value, 0),
          FlSpot(state.value, state.type.getMedium),
          FlSpot(0, state.type.getMedium),
        ],
        isCurved: false,
        curveSmoothness: 0,
        colors: const [
  ...
  getLarge() => LineChartBarData(
        spots: [
          FlSpot(state.value, 0),
          FlSpot(state.value, state.type.getGreasy),
          FlSpot(0, state.type.getGreasy),
        ],
        isCurved: false,
        curveSmoothness: 0,
        colors: const [
